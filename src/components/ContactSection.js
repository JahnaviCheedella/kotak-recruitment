...
const ContactSection = () => {
    return (
        <Box
            ...
            sx={{
                py: { xs: 8, md: 12 },
                background: 'linear-gradient(135deg, #0A2463 0%, #1E3A7B 40%, #051845 100%)',
                position: 'relative',
                overflow: 'hidden',
            }}
        >
                            ...
                            <Grid container direction="column" spacing={2}>
                                ...
                                <Grid>
                                    <Typography variant="body1" sx={{ color: 'rgba(255,255,255,0.65)', lineHeight: 1.8 }}>
                                        Take the first step towards an exciting career with Kotak Life Insurance.
                                        Contact us today and let us guide you on your path to success.
                                    </Typography>
                                </Grid>
                                                                    ...
                                                                    <Grid>
                                                                        <Typography
                                                                            ...
                                                                            sx={{
                                                                                color: '#fff',
                                                                                fontWeight: 600,
                                                                                fontSize: { xs: '0.70rem', sm: '1.05rem' },
                                                                            }}
                                                                        >
                                                                            {item.value}
                                                                        </Typography>
